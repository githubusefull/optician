...
const DoctorCard = ({doctor}) => {
  ...
  return (
    ...
    <div>
        <img src={photo} className='w-full rounded-[10px]' />
    </div>
    ...
    <div className='mt-2 lg:mt-4 flex items-center justify-between'>
        ...
        <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
          <div>
            <h3 className='text-[16px] leading-7 lg:text-[18px] lg:leading-[30px] font-semiblod text-headingColor'>
              +{totalPatients} patients
            </h3>
            <p className='text-[14px] leading-6 font-[400] text-textColor'>At {hospital}</p>
          </div>
          <Link to="/doctors"
          className='w-[44px] h-[44px] rounded-[10px] border border-solid border-[#181A1E] flex items-center justify-center
